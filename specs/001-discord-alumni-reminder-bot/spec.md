...
**Why this priority**: Agenda collection is a core purpose of the bot and must feel lightweight for members.
...
- **FR-001**: The bot MUST load configuration from environment variables: `DISCORD_TOKEN`, `GUILD_ID`, `ANNOUNCEMENT_CHANNEL_ID`, `ALUMNI_ROLE_ID`, `TIMEZONE`, and `EVENT_NAME_FILTER`.
